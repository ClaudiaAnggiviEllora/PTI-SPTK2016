                    ...
                    <div class="top-menu">
                        <ul class="cl-effect-16">
                            ...
                            <li><a  data-hover="Lihat Data">Lihat Data
                                    ...
                                    <ul><a class="active"  href="DataPelamar.jsp" value="dataPelamar"> PELAMAR PEKERJAAN</a> </ul>
            ...
            <div class="header-middle">
                <div class="container">
                    <div class="logo">
                        ...
                        <br>
                        <h1>TABEL DATA PELAMAR PEKERJAAN</h1>
                        <table border ="1">
                            <p align="center">
                            <tr bgcolor="#003366">
                            ...
                            <%
                                ...
                                query = "select userName, kodeIklan, telepon from tabelpelamar";
