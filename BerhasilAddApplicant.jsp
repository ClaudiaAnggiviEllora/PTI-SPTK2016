...
<html>
    ...
    <body>
                    ...
                    <div class="top-menu">
                        <ul class="cl-effect-16">
                            ...
                            <li><a  data-hover="Tambah Data">Tambah Data
                                    <ul><a class="active" href="FormAddApplicant.jsp" value="applicant"> Applicant (Tenaga Kerja)</a> </ul>
                            ...
                            <li><a  data-hover="Lowongan Pekerjaan">Lowongan Pekerjaan
                                    ...
                                    <ul><a  href="LamanKonfirmasiIklan1.jsp" data-hover="KONFIRMASI LOWONGAN KERJA">KONFIRMASI LOWONGAN KERJA </a></ul>
                                    <ul><a  href="LihatDataLoker.jsp" data-hover="INFORMASI LOWONGAN KERJA">INFORMASI LOWONGAN KERJA </a></ul>
                                    <ul><a href="hapusInfoLoker.jsp" data-hover="Hapus Lowongan Pekerjaan">Hapus Lowongan Kerja</a></ul>
                                </a></li>
        ...
        <div class="section-contact">
            <div class="container">
                <h2>Data Applicant berhasil ditambahkan!</h2>
                ...
                <div class="contact-main">
                    ...
                    <div class="col-md-6 contact-grid">
                        <form action="ServletApplicant" name="myform" id="myform" method="post">
                            ...
                            <!--                            Sudah Menikah <input type="checkbox" name="Sudah Menikah" value="sudahMenikah" onfocus="this.value = '';" onblur="if (this.value == '') {
                                                                    this.value = '';
                                                                }">
                                                        Belum Menikah <input type="checkbox" name="Belum Menikah" value="belumMenikah" onfocus="this.value = '';" onblur="if (this.value == '') {
                                                                    this.value = '';
                                                                }">-->
                            <br><br>
