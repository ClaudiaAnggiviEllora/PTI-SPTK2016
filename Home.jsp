                ...
                <div class="container">
                    ...
                    <div class="top-menu">
                        <ul class="cl-effect-16">
                            ...
                            <li><a href="FormSignUpApp.jsp"data-hover="REGISTER">REGISTER <select class="sub-menu"><a href="FormSignUpApp.jsp"><option  value="applicant"> Applicant (Tenaga Kerja)</option></a>
