                    ...
                    <div>
                        ...
                        <div class="col-md-7 info">
                            <section class="ac-container">
                                ...
                                <li><a data-hover ="Form Add Loker"> Add Loker <select class="sub-menu"><option class="active" value ="admin"
                                        <option valie ="admin" Admin </option> </select> </a>
                                <label>Job</label>
                                <input placeholder="Job" type="text" name="Job">
                                <label>Owner</label>
                                <input placeholder="Owner" type="text" name="Owner">
                                <label>NoKTP</label>
                                <input placeholder="NoKTP" type="text" name="NoKTP">
                                <label>NoTlpn</label>
                                ...
                                <input placeholder="Kode Loker" type="text" name="Kode Loker">
