<%-- 
    Document   : LamanKonfirmasiIklan
    Created on : Apr 13, 2016, 3:35:16 AM
    Author     : HP
--%>
<html>
    <head>
        ...
        <div id="home" class="header">
            <div class="header-top">
                <div class="container">
                    ...
                    <body>
                        <h3>Konfirmasi Iklan</h3>
                        <div>
                            <form action="action_page.php">
                                <div>
                                    <label for="Job">Job : Satpam</label>
                                </div>

                                <div>
                                    <label for="job">Owner : Krisna Ilham</label>
                                </div>

                                <div>
                                    <label for="noKTP">noKTP : 09123456789</label>
                                </div>

                                <div>
                                    <label for="NPWP">NPWP : 1234</label>
                                </div>

                                <div>
                                    <label for="noTelepon">noTelepon : 123-2345-678</label>
                                </div>

                                <div>
                                    <label for="Perusahaan">Perusahaan : Kimia Farma</label>
                                </div>
                                ...
                                <div>
                                    <label for="KodeLoker">Kode Iklan : 1234567</label>
                                </div>
