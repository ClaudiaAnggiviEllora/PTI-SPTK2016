...
<html>
    ...
    <body>
                ...
                <div class="container">
                    ...
                    <div class="top-menu">
                        <ul class="cl-effect-16">
                            ...
                            <li><a class="active" href="LamanProfileCust.jsp" data-hover="Edit Data">Profile Customer</a></li>
        ...
        <div class="about">
            <div class="container">
                <h3 class="tittle">Profile Customers</h3>
                <div class="about-top">
                    <div class="col-md-5 ab-text">
                        <img src="images/ab.jpg" alt=""/>
                        <div class="author-title">
                            <span class="author-designation">Customers,</span> <%=resultSet.getString("username")%> </div>
                    </div>
                </div>
                <div class="col-md-7 info">
                    <section class="ac-container">
                        <label> Name            :  <%=resultSet.getString("namaCust")%>  </label>	
                        <label> Alamat          :  <%=resultSet.getString("alamatCust")%>  </label>
                        <label> Nomor Telephone :  <%=resultSet.getString("noTelpCust")%>  </label>
                    </section>
                    ...
                    <form action="EditDataCust.jsp" name="myform" id="myform">
