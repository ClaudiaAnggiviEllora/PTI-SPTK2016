...
public class ServletEditProfile extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String telepon = request.getParameter("noTelpCust");
       ...
       cust.setAbout(about);
        ...
        try {
            ...
            query = "UPDATE tabelcustomers set namaCust='" + cust.getNamaCust() + "', passwordUser='" + cust.getPasswordUser() + "', noTelpCust='" + cust.getNoTelpCust() + "', alamatCust='" + cust.getAlamatCust() + "', about='" + cust.getAbout() + "' WHERE userName = '" + userName + "'";
            String query2 = "UPDATE tabellogin set passwordUser='" + cust.getPasswordUser() + "' WHERE userName = '" + userName + "'";
