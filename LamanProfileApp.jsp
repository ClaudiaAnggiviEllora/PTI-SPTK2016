		...
		<div class="header-top">
			<div class="container">
				...
				<ul class="cl-effect-16">
						...
						<li><a href="contact.html" data-hover="CONTACT">Sign In</a></li>
					</ul>
				</div>
            <!-- script-for-menu -->
				<script>
...
<!--about-->
	   <div class="about">
		     <div class="container">
			 	<h3 class="tittle">Profile Applicant</h3>
				 <div class="about-top">
				       <div class="col-md-5 ab-text">
					     <img src="images/ab.jpg" alt=""/>
						<div class="author-title"><span class="author-designation">Applicant,</span> Bejo</div>
						</div>
					   </div>
					...
					<section class="ac-container">
									<div>
										...
										<label for="ac-1">Name : Bejo </label>	
                                                                        </div>
									<div>
										
										<label for="ac-2">Nomor Telephone : 089876654532 </label>
										
									</div>
									<div>
										
										<label for="ac-3">Alamat : Sleman - Yogyakarta </label>
